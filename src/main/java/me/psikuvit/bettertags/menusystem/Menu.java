...
public abstract class Menu implements InventoryHolder {
    ...
    protected BetterTags plugin;
    protected PlayerMenuUtility playerMenuUtility;

    public Menu(PlayerMenuUtility playerMenuUtility, BetterTags plugin) {
        this.playerMenuUtility = playerMenuUtility;
        this.plugin = plugin;
    }
    protected Inventory inventory;
    protected ItemStack FILLER_GLASS_10 = makeItem(new ItemStack(Material.GRAY_STAINED_GLASS_PANE,1), " ");
    protected ItemStack FILLER_GLASS_8 = makeItem(new ItemStack(Material.GRAY_STAINED_GLASS_PANE,1), " ");
    ...
    public void setFillerGlass(){
        for (int i = 0; i < getSlots(); i++) {
            if (inventory.getItem(i) == null){
                inventory.setItem(i, FILLER_GLASS_10);
            }
        }
